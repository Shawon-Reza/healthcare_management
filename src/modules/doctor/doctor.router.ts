...
doctorRouter.post("/createDoctorProfile", authMiddleware(["ADMIN","SUPER_ADMIN"]), zodValidationFN(createDoctorProfilePayloadSchema), doctorController.createDoctorProfile);
