/*
  ...
  - Changed the type of `bloodGroup` on the `PatientHealthData` table. No cast exists, the column would be dropped and recreated, which cannot be done if there is data, since the column is required.
...
-- AlterTable
ALTER TABLE "PatientHealthData" DROP COLUMN "bloodGroup",
...
CREATE TABLE "Payment" (
    ...
    "amoount" DOUBLE PRECISION NOT NULL,
